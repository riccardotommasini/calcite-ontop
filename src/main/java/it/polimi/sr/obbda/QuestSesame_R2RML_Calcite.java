...
public class QuestSesame_R2RML_Calcite {
    ...
    public static void main(String[] args) throws Exception {
        QuestSesame_R2RML_Calcite example = new QuestSesame_R2RML_Calcite();
        example.run();
    ...
    public void run() throws Exception {
        ...
        preferences.setCurrentValueOf(QuestPreferences.JDBC_URL, "jdbc:calcite:");
        ...
        repo.initialize();
        CalciteConnection unwrap = repo.getQuestConnection().getConnection().unwrap(CalciteConnection.class);
