...
public class QuestOWL_OBDA_Postgres {
    ...
    final String obdaFile = "src/main/resources/postgres/exampleBooks.obda";
    ...
    public static void main(String[] args) {
        try {
            QuestOWL_OBDA_Postgres example = new QuestOWL_OBDA_Postgres();
            example.run();
        } catch (Exception e) {
            e.printStackTrace();
        }
